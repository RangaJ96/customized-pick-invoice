...
def ocr_using_google_api(image_path, request_url):
    ...
    with open("response.json") as f:
        ...
        if a:
            ...
            list_bounding_boxes = \
                json_response_data['fullTextAnnotation']\
                    ['pages'][0]['blocks']
            ...
            for bounding_box in list_bounding_boxes:
                ...
                for paragraphs in list_paragraphs:
                    ...
                    for words in list_words:
                        ...
                        list_bounding_box_para.append(words['boundingBox'])
                        ...
                        # list_word_coordinates_para = \
                        #     [list(chain(*[[x['x'], x['y']] for x in \
                        #                   i['vertices']])) for i in para_bbox]
        ...
        for int_index, llst_block_coordinate in enumerate(list_block_coordinates):
            #print(int_index)
            print(list_block_words[int_index])
            print(llst_block_coordinate)
            llst_block_coordinate.insert(0, list_block_words[int_index])

        # print('block')
        # print(list_block_words)
        # print(list_block_coordinates)
        # print("Para :")
        ...
        df = pd.DataFrame(list_word_objects,
                            columns=['xmin', 'ymin', 'xmax', 'ymax', 'Object'])

        print(df['Object'])


ocr_using_google_api("image_path", "request_url")